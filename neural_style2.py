...
#tempory fix. should migrate to tf 2.
...
def stylize(content_img, style_imgs, init_img, frame=None):
  # orig line below only works with tf version 1
  with tf.device(args.device), tf.compat.v1.Session() as sess:
  #below- updated line to work with tensorflow 2.0
  # with tf.device(args.device), tf.compat.v1.Session() as sess:
    # setup network
...
# --content_img "mittenwald.jpg" \
# --content_img_dir "C:\\Users\\jerem\\Documents\\Python\\neural-style-tf\\image_input\\mittenwald.jpg" \
# --style_imgs "starry-night.jpg" \
# --style_imgs_dir "C:\\Users\\jerem\\Documents\\Python\\neural-style-tf\\styles" \
# --device "/cpu:0" \
# --verbose;
